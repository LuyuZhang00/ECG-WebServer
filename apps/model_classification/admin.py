...
admin.site.site_header = '心电心音管理平台'  # 设置header
admin.site.site_title = '心电心音管理平台'  # 设置title
admin.site.index_title = '心电心音管理平台'


from .models import ModelManage
@admin.register(ModelManage)
class HospitalManage(ImportExportModelAdmin):
    # 设置页面可以展示的字段
    list_display = ("model_name", "model_file", "model_describe",
                    "model_type","model_version", "model_author","model_link",
                    "is_use", "is_delete",
    ...
    list_editable = ("is_use", "is_delete",)
    # 按日期月份筛选 该属性一般不用
    ...
    fieldsets = (
        (None, {
            'fields': ("model_name", "model_file", "model_describe",)
        }),
        ('选填字段', {
            'classes': ('wide', 'extrapretty',),
            'fields': ("model_type","model_version", "model_author","model_link","is_use", "is_delete",
              ),
        }),
    )
    ...
    #     return super(ModelManage, self).change_view(request, object_id,
